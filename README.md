# Beyond Paper Mastering Ar Business Cards
...
Beyond Paper Mastering Ar Business Cards is a hands-on course focused on practical
...
- Understand the core goals of the **Beyond Paper Mastering Ar Business Cards** lessons.
...
sensors/actuators described in the Beyond Paper Mastering Ar Business Cards videos, jumper
...
# Or upload via Arduino IDE to replicate the Beyond Paper Mastering Ar Business Cards lab
```
...
- Course: Beyond Paper: Mastering AR Business Cards
- Author: Ashraf S A AlMadhoun
- Link: https://www.udemy.com/course/augmented-reality-beyond-paper-crafting-cutting-edge-ar-business-cards/?couponCode=JULYMAXDICOUNT

## Overview

Implement marker detection and AR overlays to bring printed cards to life.

## Purchase With Discount

Enroll using the link above to get a discounted price and create AR business cards.
